...
//
//        assertEquals(Map.of( 5, Arrays.asList("bison"),
//                             6, Arrays.asList("avocet"),
//                             7, Arrays.asList("bustard"),
//                             8, Arrays.asList("aardvark", "capybara", "bushbaby", "capuchin"),
//                             9, Arrays.asList("alligator"),
//                            10, Arrays.asList("chimpanzee")),
//                     result);
//    }
//    // <editor-fold defaultstate="collapsed">
